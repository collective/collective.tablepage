...
(function ($) {
    ...
    $.fn.rowGrouping = function (options) {
        ...
        return this.each(function (index, elem) {
            ...
            function _fnGetCleanedGroup(sGroup, strict_text) {
                if (sGroup === "") return "-";
				if (strict_text) {
					// Do not clean the whole HTML, but the contained text only
...
//                          sGroupData = oSettings.aoData[oSettings.aiDisplay[iDisplayIndex]]._aData[oSettings.aoColumns[properties.iGroupingColumnIndex].mDataProp];
                        ...
                        if (sLastGroup == null || _fnGetCleanedGroup(sGroup, true) != _fnGetCleanedGroup(sLastGroup, true)) { // new group encountered (or first of group)
							var sGroupCleaned = _fnGetCleanedGroup(sGroup, true);
